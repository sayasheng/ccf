...
public class ExportContactInfoDialogWithAddress extends DialogCombo{
	private static String title = "通訊錄(含地址)輸出";
					...
					mErrorFileDialog.setMessage("執行此輸出資料庫檔案的動作,將會覆蓋原有的檔案!!");
	  	            ...
	  	            case SWT.OK:
	  	            	...
	  	            	if (mDBListComboYesOrNo.getText().equals("否"))
							mUiDbInterface.exportContactInfoAddress(mDirPathSelectedText.getText(),years,false);
						else
							mUiDbInterface.exportContactInfoAddress(mDirPathSelectedText.getText(),years,true);
	...
	public ExportContactInfoDialogWithAddress (Display display) throws SQLException{
