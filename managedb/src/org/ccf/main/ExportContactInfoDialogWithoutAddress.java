...
public class ExportContactInfoDialogWithoutAddress extends DialogCombo{
	
	private static String title = "通訊錄(不含地址)輸出";
					...
					mErrorFileDialog.setMessage("執行此輸出資料庫檔案的動作,將會覆蓋原有的檔案!!");
	  	            ...
	  	            case SWT.OK:
	  	            	...
	  	            	if (mDBListComboYesOrNo.getText().equals("否"))
							mUiDbInterface.exportContactInfoNoAddress(mDirPathSelectedText.getText(),years,false);
						else
							mUiDbInterface.exportContactInfoNoAddress(mDirPathSelectedText.getText(),years,true);
